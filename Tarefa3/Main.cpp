...
int main(int argc, char* argv[]) {
	...
	Scene* scene = new Scene(100, 100, 400, 400, 20, new Color(100, 100, 100, 255));
	...
	scene->camera(new Vector(70., 0., 160.), new Vector(-150., 0., 150.), new Vector(0., 10000, 0.));
	...
	//scene->camera(new Vector(150., 20., 270.), new Vector(-1.1, 0., -2.), new Vector(0., 1., 0.)); //visao grande da sala
	...
	//scene->camera(new Vector(50., 0., 200.), new Vector(0., 0., 0.), new Vector(0., 1., 0.)); // diagonal esquerda mais perto
